...
- 内容：`auxiliary/` 下 19 篇文档（01-19）+ `lessons/`；导航入口 = `auxiliary/README.md`，知识地图 = `auxiliary/07-场景体系总览.md`。
...
2. **对标未来 ROS2 架构与程序设计**（`auxiliary/15-19` 为此而建）。
...
6. **诚实**：明确标注「框架不覆盖什么」（见 01 附 / 0.5.4 四域分类）；不夸大覆盖度。
