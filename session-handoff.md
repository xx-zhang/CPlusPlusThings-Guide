...
| 文档全集 | `auxiliary/00~31` + `lessons/01` + **`check.sh`** + 根 README/AGENTS/handoff/TODO | ✅ 32 篇 + 1 脚本 |
...
（本次）`29` 具身智能技术栈覆盖审计（9 仓库扫描）· `30` 原仓库阅读导览（降心智负担）· `31` CppCoreGuidelines 中文导读（441 编号全索引 + P 全译 + 18 条互证 + 10 项缺口）
